...
2. [Communication Interfaces](#2-communication-interfaces)
   ...
   - 2.2 [UART](#22-uart)
   - 2.3 [SPI / I²C / RS485 / LIN (Bridge)](#23-spi--i2c--rs485--lin-bridge)
   - 2.4 [CAN](#24-can)
   - 2.5 [Wi-Fi / BLE](#25-wi-fi--ble)
...
5. [Programming Workflow](#5-programming-workflow)
   - 5.1 [Connection Sequence](#51-connection-sequence)
   - 5.2 [Device Identification](#52-device-identification)
   - 5.3 [Programming Sequence](#53-programming-sequence)
   - 5.4 [Retry and Error Recovery](#54-retry-and-error-recovery)
6. [Flash Layout and Size Resolution](#6-flash-layout-and-size-resolution)
7. [API Reference](#7-api-reference)
   - 7.1 [ISPLdCMD Class](#71-ispldcmd-class)
   - 7.2 [CISPProc Class](#72-cisproc-class)
